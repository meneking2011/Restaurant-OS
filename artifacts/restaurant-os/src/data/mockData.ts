import { RestaurantConfig, MenuItem, Service, Testimonial, GalleryImage, Order } from "../types/restaurant";
...
export const mockOrders: Order[] = [
  {
    ...
    phone: "(555) 123-4567",
    deliveryAddress: "45 Oakwood Drive, Holistic Springs, CA 90210",
    items: [
      { menuItemId: "m4", name: "A5 Wagyu Medallions", quantity: 2, price: 110 },
      { menuItemId: "m3", name: "Heirloom Tomato & Burrata Caprese", quantity: 1, price: 26 },
    ],
    paymentMethod: "card",
    status: "completed",
    subtotal: 246,
    ...
    tax: 19.68,
    totalAmount: 280.68,
    orderedAt: "2026-07-10T19:15:00Z",
  },
  {
    id: "ord-1002",
    ...
    phone: "(555) 234-5678",
    deliveryAddress: "12 Maple Lane, Holistic Springs, CA 90210",
    items: [
      { menuItemId: "m1", name: "Seared Duck Breast", quantity: 1, price: 48 },
      { menuItemId: "m5", name: "Chocolate Avocado Mousse", quantity: 2, price: 22 },
    ],
    paymentMethod: "bank",
    status: "preparing",
    subtotal: 92,
    ...
    tax: 7.36,
    totalAmount: 114.36,
    specialNotes: "Extra sauce on the duck please.",
    orderedAt: "2026-07-12T18:45:00Z",
  },
  {
    id: "ord-1003",
    ...
    phone: "(555) 345-6789",
    deliveryAddress: "88 Pine Street, Holistic Springs, CA 90210",
    items: [
      { menuItemId: "m2", name: "Herb-Crusted Halibut", quantity: 1, price: 55 },
      { menuItemId: "m7", name: "Smoked Old Fashioned", quantity: 2, price: 24 },
    ],
    paymentMethod: "card",
    status: "new",
    subtotal: 103,
    ...
    tax: 8.24,
    totalAmount: 126.24,
    orderedAt: "2026-07-12T20:05:00Z",
  },
  {
    id: "ord-1004",
    ...
    phone: "(555) 456-7890",
    deliveryAddress: "220 River Rd, Holistic Springs, CA 90210",
    items: [
      { menuItemId: "m6", name: "Wild Mushroom Risotto", quantity: 2, price: 36 },
    ],
    paymentMethod: "card",
    status: "ready",
    subtotal: 72,
    ...
    tax: 5.76,
    totalAmount: 92.76,
    orderedAt: "2026-07-12T19:30:00Z",
  },
  {
    id: "ord-1005",
    ...
    phone: "(555) 567-8901",
    deliveryAddress: "5 Elm Court, Holistic Springs, CA 90210",
    items: [
      { menuItemId: "m4", name: "A5 Wagyu Medallions", quantity: 1, price: 110 },
      { menuItemId: "m8", name: "Oysters on the Half Shell", quantity: 1, price: 32 },
      { menuItemId: "m7", name: "Smoked Old Fashioned", quantity: 1, price: 24 },
    ],
    paymentMethod: "card",
    status: "completed",
    subtotal: 166,
    ...
    tax: 13.28,
    totalAmount: 194.28,
    orderedAt: "2026-07-11T20:00:00Z",
  },
  {
    id: "ord-1006",
    ...
    phone: "(555) 678-9012",
    deliveryAddress: "33 Birch Ave, Holistic Springs, CA 90210",
    items: [
      { menuItemId: "m1", name: "Seared Duck Breast", quantity: 2, price: 48 },
    ],
    paymentMethod: "bank",
    status: "cancelled",
    subtotal: 96,
    ...
    tax: 7.68,
    totalAmount: 118.68,
    orderedAt: "2026-07-09T18:00:00Z",
  },
];
